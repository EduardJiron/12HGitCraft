 ...
 * Use the [GestionUsuarioCraftFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class GestionUsuarioCraftFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment GestionUsuarioCraftFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            GestionUsuarioCraftFragment().apply {
